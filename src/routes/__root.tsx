...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Evidence-informed coaching systems for ambitious individuals seeking sustainable fat loss, muscle gain and peak human performance." },
      { name: "author", content: "LEANMOVEMENT" },
      { property: "og:title", content: "LEANMOVEMENT — Become The Strongest Version Of Yourself" },
      { property: "og:description", content: "Evidence-informed coaching systems for ambitious individuals seeking sustainable fat loss, muscle gain and peak human performance." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "LEANMOVEMENT — Become The Strongest Version Of Yourself" },
      { name: "twitter:description", content: "Evidence-informed coaching systems for ambitious individuals seeking sustainable fat loss, muscle gain and peak human performance." },
